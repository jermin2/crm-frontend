...
import Auth0LoginTab from './tabs_old/Auth0LoginTab';
import FirebaseLoginTab from './tabs_old/FirebaseLoginTab';
import JWTLoginTab from './tabs_old/JWTLoginTab';
          ...
          <div className="max-w-320">
            ...
            >
              <Typography variant="h3" color="inherit" className="font-semibold leading-tight">
                Welcome <br />
                to the <br /> Church in Auckland CRM
              </Typography>
            </motion.div>
